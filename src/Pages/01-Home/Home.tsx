...
const Home: React.FC = () => {
  ...
  const [currentIndex, setCurrentIndex] = useState(0);
    ...
    // ✅ SEO Keywords Array
  const keywords = [
    "cricket tournament maker",
    "box cricket ground size",
    "resort with cricket ground",
    "cricket summer camp",
    "cricket academy fees",
    "women's cricket academy near me",
    "cricket team names for local tournament",
    "female cricket academy",
    "badminton tournament near me",
    "cricket ground booking",
    "cricket ground booking in hyderabad",
    "cricket academy with school and hostel",
    "cnr cricket ground 2",
    "cricket ground for rent",
    "turf cricket ground near me",
    "turf football ground near me",
    "cricket academy near me with low fees",
    "box cricket turf",
    "basketball ground near me",
    "next level cricket academy",
    "cheapest cricket academy near me",
    "players cricket academy",
    "turf cricket near me",
    "turf box cricket",
    "cricket net practice near me",
    "mrr cricket ground",
    "vscg cricket ground",
    "basketball courts near me",
    "striker sports indoor academy",
    "indoor cricket nets near me",
    "badminton hall",
    "cricket bowling machine near me",
    "book cricket ground near me",
    "hsr layout cricket ground",
    "snr college cricket ground coimbatore",
    "new madies cricket ground",
    "best cricket academy near me",
    "cooperage ground",
    "cricket nets near me",
    "table tennis club near me",
    "cricket ground booking near me",
    "cricket academy near me with fees",
    "box cricket",
    "cricket turf near me",
    "badminton court booking",
    "football ground in india",
    "how to become a cricketer without academy",
    "indoor cricket near me",
    "box cricket near me",
    "ground booking app",
    "scf cricket ground salem",
    "free cricket academy near me",
    "government cricket academy near me",
    "nearest playground near me",
    "turf near me for cricket",
    "pool table near me",
    "table tennis court near me",
    "flying feathers badminton academy",
    "football ground near me",
    "cricket ground near me",
    "synthetic ground near me",
    "cricket academy near me",
    "insports cricket academy",
    "turf near me",
    "cricket near me",
    "badminton turf near me",
    "salem cricket ground",
    "ayr cricket ground",
    "cricket academy in salem",
  ...
  return (
    ...
    <div className="text-[#090a58] overflow-x-hidden">
      ...
      <Helmet>
        <title>ZadBy - Cricket Ground Booking, Box Cricket Turf, Academies & Tournaments in India</title>
        <meta 
          name="description" 
          content="Book cricket grounds, turf football, badminton & basketball courts easily with ZadBy. Explore box cricket turf, summer camps, female cricket academies, indoor nets, and low-fee cricket academies near you. Join tournaments, practice sessions, and training programs today!" 
        />
        ...
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex gap-2 z-10">
          {images.map((_, i) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition ${i === currentIndex ? "bg-white" : "bg-gray-400"
                }`}
            />
          ))}
        </div>
